...
public class AssertionsExmple {
    ...
    @Test
    public void hamcrestMatchersMultipleAssertionsHasKey() {
        given()
                .queryParam("query", "ipod")
                .queryParam("apiKey", APIKEY)
                .queryParam("format", "json")
    ...
    @Test
    public void hamcrestMatchersMultipleAssertionsKeyValuePairsInArray() {
        ...
        given()
                ...
                .get("/search")
                .then()
                .body("items.findAll{it.name==~/App.*/}",hasItems(hasEntry("name","Apple iPod touch 32GB")));
